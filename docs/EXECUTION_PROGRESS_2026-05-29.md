...
- current_scope: C-21 OCEAN Metric Extraction Retry Policy complete and committed in the current HEAD.
- next_allowed_action: finish final verification and commit, then wait for user confirmation before choosing the next narrow real-practice-backed optimizer or execution-agent validation step.
