...
- Plan C C-10 real-run failure/retry policy contract: design spec and implementation plan complete; implementation pending.
...
C-6, C-7, C-8, and C-9 are closed. C-10 is planned but not implemented. Next:
