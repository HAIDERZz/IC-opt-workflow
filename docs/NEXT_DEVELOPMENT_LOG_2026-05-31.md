...
- Plan C C-10 real-run failure/retry policy contract: Task 1 recovery report schemas complete and reviewed; Task 2 pending.
...
- Task 2: deterministic recovery classifier.
...
C-6, C-7, C-8, C-9, and C-10 Task 1 are closed. The workflow returns to a per-task stop-and-report cadence. Next:

- Wait for user confirmation, then execute C-10 Task 2 from `docs/superpowers/plans/2026-06-02-real-run-failure-retry-policy-contract.md` using Subagent-Driven Development.
- Stop after Task 2 is implemented, verified, reviewed, committed, and recorded; do not proceed to Task 3 without user confirmation.
