...
- Next required action: finish the scoped C-7 command fix, then decide whether the next scoped fix is exported netlist bundle sidecars, Spectre-safe unit formatting, or metric namespace/formula contract
