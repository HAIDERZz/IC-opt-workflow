...
- Next allowed action: wait for user confirmation, then execute Candidate-Injection Package Contract Task 1 only.
...
Current next step: execute Candidate-Injection Package Contract Task 1 after user confirmation. Do not commit raw input decks, protected include files, PSF/raw data, full Cadence logs, `docs/OCEAN_DOC_*`, or `docs/toolchain_evidence/`. Do not parse PSF or translate OCEAN formulas in Python.
